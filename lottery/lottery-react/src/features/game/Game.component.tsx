...
function GameComponent() {
  ...
  if (!isConnected) {
    return (
      <div className="gameContainer h-full py-6">
        <button
          onClick={connectWallet}
          className="buttonGlow bg-[#3498DB] text-white text-xl py-3 rounded-lg px-6 transition-colors  duration-300 cursor-pointer block ml-auto mr-6"
        >
          Connect Wallet
        </button>
      </div>
  ...
  return (
    <div className="gameContainer py-6 text-white px-12 h-full flex flex-col justify-between">
      <div>
        {isConnected && (
          <div className="buttonGlow w-fit bg-[#3498DB] text-white text-xl py-3 rounded-lg px-6 transition-colors  duration-300 cursor-pointer   block ml-auto mr-6">
            {userAccount}
          </div>
        )}
        <div className="flex flex-col gap-6">
          ...
          <div>
            ...
            <span className="text-lg font-regular ml-32">{manager}</span>
          </div>
          <div>
            <button
              onClick={() => setOpenPay(!openPay)}
              className="text-2xl mt-6 buttonGlow w-fit bg-[#3498DB] text-white py-3 rounded-lg px-6 transition-colors  duration-300 cursor-pointer"
            >
              CONTRIBUTE
            </button>
          </div>
